...
const updateModal = (state, elements) => {
  const { modalTitle, modalBody, modalFullArticleLink } = elements
  ...
  if (modalFullArticleLink) modalFullArticleLink.href = post.link
}
...
const setupModalHandlers = (state, postsContainer, elements) => {
